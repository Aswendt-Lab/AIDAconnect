function plotNodes(graphCell,inputDTI,limits,options,displayOptions)
...
% Generate Legend
subplot('Position', [0.555 0.13 0.29 0.215])
    view([90 90]);
    annotation('textbox', [0.56, 0.24, 0.1, 0.1], 'string', ...
        "Circle diameter:", 'FontWeight', 'bold', ...
        'FontSize', 10, 'EdgeColor', 'none');
    annotation('textbox', [0.56, 0.21, 0.1, 0.1], 'string', ...
        "Min. Avg. Node Strength: "+round(limits{3}(1)), ...
        'FontSize', 10, 'EdgeColor', 'none');    
    annotation('textbox', [0.56, 0.18, 0.1, 0.1], 'string', ...
        "Max. Avg. Node Strength: "+round(limits{3}(2)), ...
        'FontSize', 10, 'EdgeColor', 'none');
    annotation('textbox', [0.56, 0.14, 0.1, 0.1], 'string', ...
        "Line thickness:", 'FontWeight', 'bold', ...
        'FontSize', 10, 'EdgeColor', 'none');
    annotation('textbox', [0.56, 0.11, 0.1, 0.1], 'string', ...
        "Min. Edge Weight: "+round(limits{2}(1)), ...
        'FontSize', 10, 'EdgeColor', 'none');
    annotation('textbox', [0.56, 0.08, 0.1, 0.1], 'string', ...
