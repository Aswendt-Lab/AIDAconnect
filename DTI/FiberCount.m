function AllTable = FiberCount(inputDTI, graphCell, startP, endP)
...
for day = 1:numOfDays
    tableGroup.Properties.VariableNames(day) = inputDTI.days(day);
end
disp(strcat("Fiber Count ",startP," to ",endP," in group ",inputDTI.groups(group),':'));
disp(tableGroup);
