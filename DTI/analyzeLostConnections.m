function analyzeLostConnections(inputDTI, graphCell, selectedRegion, day1, day2)
...
% lost connections with small weights in line 17. In case of DTI, 
...
%% Example
% analyzeLostConnections(inputDTI, graphCell, "L SSp-ll", "Baseline", "P7")
...
for group_id = 1:size(inputDTI.groups,2)
    ...
    disp('Lost connections of '+string(selectedRegion)+' in group '+inputDTI.groups(group_id)+' from '+day1+' to '+day2+':');
